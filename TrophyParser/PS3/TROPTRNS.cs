    ...
    public class TROPTRNS
    {
        ...
        public TROPTRNS(string path_in)
        {
            ...
            try
            {
                ...
                {
                    TypeRecord TypeRecordTmp = TROPTRNSReader.ReadBytes(Marshal.SizeOf(typeof(TypeRecord)))
                        .ToStruct<TypeRecord>();
        ...
        public void Save()
        {
            BigEndianBinaryWriter TROPTRNSWriter =
                new BigEndianBinaryWriter(new FileStream(path + "TROPTRNS.DAT", FileMode.Open));
        ...
        public int Count
        {
            get { return trophyInfoTable.Count; }
        }
        ...
        public struct TrophyInfo
        {
            ...
            public int SequenceNumber
            {
                ...
                set { _sequenceNumber = value.ChangeEndian(); }
            }
            ...
            public bool IsExist
            {
                set { _isExist[3] = (byte) ((value) ? 2 : 0); }
                get { return (_isExist[3] == 2) ? true : false; }
            }
            ...
            public bool IsSync
            {
                set { _syncState[3] = (byte) ((value) ? 1 : 0); }
                get { return (_syncState[3] == 0) ? false : true; }
            }
            ...
            public int TrophyID
            {
                get { return _trophyID.ChangeEndian(); }
                set { _trophyID = value.ChangeEndian(); }
            }
            ...
            {
                get { return _trophyType.ChangeEndian(); }
                set { _trophyType = value.ChangeEndian(); }
            }
            ...
            /// byte[96]
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray,
                SizeConst = 96, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
        ...
        public struct TrophyInitTime
        {
            ...
            /// byte[112]
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray,
                SizeConst = 112, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
            public byte[] padding2;
        }
