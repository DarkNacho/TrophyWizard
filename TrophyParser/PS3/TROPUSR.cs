...
namespace TrophyParser.PS3
{
    ...
    public class TROPUSR
    {
        ...
        public TROPUSR(string path_in)
        {
            ...
            {
                TypeRecord TypeRecordTmp =
                    TROPUSRReader.ReadBytes(Marshal.SizeOf(typeof(TypeRecord))).ToStruct<TypeRecord>();
        ...
        public struct Header
        {
            ...
            {
                get { return _unknowCount.ChangeEndian(); }
            }


            /// byte[36]
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray,
                SizeConst = 36, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
            public byte[] padding;
        }
        ...
        public struct TypeRecord
        {
            ...
            public int unknow3
            {
                get { return _unknow3.ChangeEndian(); }
            }
            ...
            {
                get { return _usedTimes.ChangeEndian(); }
            }
            ...
            public long Offset
            {
                get { return _offset.ChangeEndian(); }
            }
            ...
            public long unknow6
            {
                get { return _unknow6.ChangeEndian(); }
            }
        ...
        public struct TrophyType
        {
            ...
            {
                get { return _sequenceNumber.ChangeEndian(); }
            }
            ...
            public int Type
            {
                get { return _type.ChangeEndian(); }
                set { _type = value.ChangeEndian(); }
            }
            ...
            /// byte[56]
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray,
                SizeConst = 56, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
            public byte[] padding;
        ...
        public struct TrophyListInfo
        {
            ...
            public DateTime ListLastUpdateTime
            {
                get
                {
                    DateTime realDateTime =
                        new DateTime(BitConverter.ToInt64(_listLastUpdateTime, 0).ChangeEndian() * 10);
                    if (realDateTime.Ticks == 0)
                    {
                        return realDateTime;
                    }
            ...
            public DateTime ListLastGetTrophyTime
            {
                ...
                {
                    DateTime realDateTime =
                        new DateTime(BitConverter.ToInt64(_listLastGetTrophyTime, 0).ChangeEndian() * 10);
                    if (realDateTime.Ticks == 0)
                    {
                        return realDateTime;
                    }
            ...
            /// byte[32]
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray,
                SizeConst = 32, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
            ...
            {
                get { return _getTrophyNumber.ChangeEndian(); }
                set { _getTrophyNumber = value.ChangeEndian(); }
            }
            ...
            /// uint[4]
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray,
                SizeConst = 4, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I4)]
        ...
        public struct TrophyTimeInfo
        {
            ...
            /// byte[4]
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray,
                SizeConst = 4, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
            private byte[] _getOrNot;

            public bool IsGet
            {
                get { return (_getOrNot[3] != 0) ? true : false; }
                set { _getOrNot[3] = (byte) ((value) ? 1 : 0); }
            }
            ...
            /// byte[64]
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray,
                SizeConst = 64, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
            public byte[] padding;
        ...
        public struct UnknowType7
        {
            ...
            {
                get { return _getTrophyCount.ChangeEndian(); }
                set { _getTrophyCount = value.ChangeEndian(); }
            }
            ...
            /// byte[8]
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray,
                SizeConst = 8, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
            ...
            /// byte[48]
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.ByValArray,
                SizeConst = 48, ArraySubType = System.Runtime.InteropServices.UnmanagedType.I1)]
            public byte[] padding2;
        }
